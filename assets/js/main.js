...
const toggleTabs = function (tabContainer) {
  const tabs = tabContainer.querySelectorAll(".tab-lr__tab-list__tab");
  const panels = tabContainer.querySelectorAll(".tab-lr__panel-list__panel");
...
const tabContainers = document.querySelectorAll(".tab-lr");
for (const tabContainer of tabContainers) {
  const tabList = tabContainer.querySelector('.tab-lr__tab-list');
